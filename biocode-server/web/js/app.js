...
biocodeApp.provider("ngModalDefaults", function() {
    return {
        options: {
...
biocodeApp.directive('modalDialog', [
...
biocodeApp.config(['$routeProvider', 'ngModalDefaultsProvider',
    function($routeProvider, ngModalDefaultsProvider) {
        $routeProvider.
            when('/projects', {
